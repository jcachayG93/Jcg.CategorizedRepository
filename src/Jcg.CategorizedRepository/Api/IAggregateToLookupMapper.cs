...
///     A light weight model representing the minimal data the user would like to see when querying the items in the category. Like an overview of an aggregate.
/// </typeparam>
