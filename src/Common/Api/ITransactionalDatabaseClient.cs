namespace Common.Api
{
        ...
        where TLookupDatabaseModel : class
    {
        ...
        /// <param name="eTag">The ETag value for the payload. Blank if this is an insert operation. Value returned by GetAggregate if this is a replace operation.</param>
        /// <param name="aggregate">The aggregate</param>
        /// <remarks>This method is responsible for checking that the eTag matches the expected value for the key, but that exception will be thrown after commit</remarks>
        ...
        /// <summary>
        /// Commits all Upsert operations added in previous steps in a single transaction. If any ETag do not match the expected vaue for the key,
        /// discard this operation and throw an exception.  
        /// </summary>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        /// <exception cref="Exception">Throw any exception if the ETag value for any of the operations do not match the expected value. In such case,
        /// discard all changes</exception>
